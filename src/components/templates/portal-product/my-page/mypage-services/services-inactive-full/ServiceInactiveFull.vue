<template>
  <div class="mypage-services-inactive-full">
    <div class="top-container">
      ...
      <div class="flex justify-between items-center service-text">
        <div class="flex items-center">
          ...
          <Tag class="service-tag" label="사용불가" type="TagRed" size="md" />
        </div>
        <DownloadIcon />
      </div>
    </div>
    ...
    <hr class="horizontal-divider" />
    <ServiceInformation :tableProps="serviceInformation" />
    <hr class="horizontal-divider" />
    <BillingInformation />
    <hr class="horizontal-divider" />
    <RefundAccount />
    <hr class="horizontal-divider" />
    <BillingHistory :tableProps="billingHistory" />
  </div>
</template>
<script setup>
...
const billingHistory = {
  ...
  columnStyles: [
    // Add your custom column styles here
...
@import 'ServiceInactiveFull.style.scss';
</style>
