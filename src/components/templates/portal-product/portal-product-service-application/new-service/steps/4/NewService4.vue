    ...
    <div>
      ...
      <section class="section-container">
        ...
        <div class="card-list-container">
          <Card :card-list="infoCard" @card-clicked="toggleSelect" class="card-spacing" />
        </div>
        <div>
      ...
      <section class="section-container">
        <div class="section-title">정보입력</div>
        <div class="flex">
          <Card :card-list="additionalInfoCard" @card-clicked="toggleSelectInfo" class="card-spacing" />
        </div>
