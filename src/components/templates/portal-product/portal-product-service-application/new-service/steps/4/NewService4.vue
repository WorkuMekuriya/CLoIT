  ...
  <div class="grid-main-container">
    <div>
      ...
      <section class="section-container">
        ...
        <div class="flex">
          <Card
            v-for="(card, index) in additionalInfoCard"
            :key="index"
            :title="card"
            size="sm"
            :selected="selectedInfoIndex === index"
            @click="toggleSelectInfo(index)"
            class="card-spacing"
          />
        </div>
...
const infoCard = ref(['Individual', 'Organization']);
