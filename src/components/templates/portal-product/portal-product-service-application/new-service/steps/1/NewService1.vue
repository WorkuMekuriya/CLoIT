<template>
  <div class="new-service-1">
    ...
    <div class="flex justify-center button-container">
              <StandardButton @click="movetoStep2(2)" type="ArcticBlue" :outlined="true" label="Next : Select Service" buttonWidth="288px" leftIcon="panorama_fish_eye"  rightIcon="panorama_fish_eye" arrowDirection="Right" />
    </div>
  </div>
</template>
<script setup>
