<template>
    <q-card class="card-container" @click="toggleCardType"
        ...
        <div class="card-header" :class="{ 'md-card-header': size == 'md', 'sm-card-header': size == 'sm' }">
            ...
            <div v-if="size == 'lg'" class="header-title">
            ...
            <div class="check-box"
                ...
                <svg v-if="size == 'lg' | (size == 'md' & isSelected) || (size == 'sm' & !isSelected)"
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M20 6L9 17L4 12" stroke="#101828" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <svg v-if="size == 'sm' & isSelected" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24" fill="none">
        ...
        <div class="card-footer" :class="{ 'md-card-footer': size == 'md', 'sm-card-footer': size == 'sm' }">
            ...
            <div v-if="size == 'lg'" class="footer-text">
                <div class="card-price">{{ price }}</div>
                <div class="card-subscription">{{ subscription }}</div>
            </div>
        </div>
    </q-card>
</template>
