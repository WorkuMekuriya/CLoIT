        ...
        <div class="">
            ...
            <div class="service-section">
                <div class="service-section-container" :style="{width: cardWidth}">
                    ...
                    <LiItem v-for="(item, index) in products" :key="index" :label="item.label" :price="item.price" />
                </div>
            ...
            <div v-if="!isCheckout" class="next-button-container">
                <RoundedButton @click="emitButtonClick" type="Primary" :label="label" :buttonDisabled="false" size="xl"
                    buttonWidth="389px" />
            </div>
        </div>
    </div>
